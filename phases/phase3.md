...
4. Interface requirements and caveats where relevant
...
For each meaningful handbook conclusion, record:
...
Those fields may be represented as a table or structured bullets, but they must be explicit enough for phase4 to reuse without rediscovering the datasheet trail.
...
5. Every major conclusion includes explicit evidence fields
...
5. Evidence fields are absent or too weak for downstream traceability
