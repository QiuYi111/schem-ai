...
SCHEMA_FILES = [
    ...
    "schemas/project_index.schema.json",
    "schemas/approved_parts.schema.json",
    "schemas/interconnect.schema.json",
]
...
def schemas_path(project_root: Path) -> Path:
...
def read_state(project_root: Path) -> dict[str, Any]:
    return merge_defaults(read_data(state_path(project_root)), default_state())


def read_index(project_root: Path) -> dict[str, Any]:
    return merge_defaults(read_data(index_path(project_root)), default_index())
